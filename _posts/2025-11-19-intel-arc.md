...
> **TL;DR:** I was able to run local LLMs using my Intel Arc A750 GPU on a system _without_ ReBAR by using the Vulkan backend.
...
FP16 support is now working for me on my Intel Arc A750 with `llama.cpp`'s Vulkan backend.

- Current result: I no longer need to disable FP16 on this setup.
- What changed since November 2025: recent Vulkan-side fixes in `llama.cpp` appear to have resolved the issue I hit originally. See this [pull request](https://github.com/ggml-org/llama.cpp/pull/18814) for details.
- If you are following this today, start by trying `llama.cpp` with the Vulkan backend without disabling FP16.
- The original post continues below for context.
...
- [Issue comment on IPEX-LLM #13212](https://github.com/intel/ipex-llm/issues/13212#issuecomment-2963576292)
- [kovasky — Ollama Vulkan on Intel](https://kovasky.me/blogs/ollama_vulkan_intel/)
- [SteelPh0enix — llama.cpp guide](https://blog.steelph0enix.dev/posts/llama-cpp-guide/)
